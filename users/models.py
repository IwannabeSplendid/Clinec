...
class Doctor(models.Model):
    ...
    IIN = models.IntegerField(max_length=12, blank=True, null=True)
    gov_id = models.IntegerField(max_length=12,blank=True, null=True)
    ...
    appointment_price = models.CharField(max_length = 7, blank=True, null=True)
...
class Patient(models.Model):
    ...
    surname = models.CharField(max_length=50, blank=True, null=True)
    middle_name = models.CharField(max_length=50, blank=True, null=True)
    blood_group = models.CharField(max_length=2, blank=True, null=True, choices=blood_group_choices)
    contact_close = models.CharField(max_length=11,blank=True, null=True)
    phone_number = models.CharField(max_length=11,blank=True, null=True)
    address = models.CharField(max_length=50, blank=True, null=True)
    marital_status = models.CharField(max_length=10, blank=True, null=True, choices = marital_status_choices)
